package com.jerrychou.structure;
...
public class DenseVector {
	...
	public DenseVector() {
		this.N = 0;
		this.map = MatrixFactory.emptyMatrix();
	}
	...
	public DenseVector(int n) {
		this.N = n;
		this.map = MatrixFactory.dense(ValueType.DOUBLE, n, 1);
	}
	...
	public DenseVector copy() {
		DenseVector newVector = new DenseVector(N);
	...
	public DenseVector plus(DenseVector b) {
		...
		return new DenseVector(v1.plus(v2));
	}
	...
	public DenseVector minus(DenseVector b) {
		...
		return new DenseVector(v1.minus(v2));
	}
...
//			throw new RuntimeException("Vector lengths disagree");
	...
	public DenseMatrix outerProduct(DenseVector b) {
		DenseMatrix A = new DenseMatrix(this.N, b.N);
	 ...
	 * @return The resulting vector after subtraction.
	 */
	public DenseVector partMinus(DenseVector b, int[] indexList) {
		if (indexList == null)
			return this;
	 ...
	 * @return The inner-product value.
	 */
	public double partInnerProduct(DenseVector b, int[] indexList) {
		double sum = 0.0;
